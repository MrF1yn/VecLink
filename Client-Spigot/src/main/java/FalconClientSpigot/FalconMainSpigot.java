...
import FalconClientSpigot.chat.ChatHandler;
import FalconClientSpigot.chat.ChatListener;
import FalconClientSpigot.commands.*;
import FalconClientSpigot.commands.handler.FalconCommand;
import FalconClientSpigot.utils.MemoryUtil;
import FalconClientSpigot.utils.SpigotReflection;
import FalconClientSpigot.support.PAPISupport;
...
public class FalconMainSpigot extends JavaPlugin implements GlobalInterface{
    private BukkitTask keepAliveTask;
    public static FalconMainSpigot plugin;
...
//        getCommand("falcon").setExecutor(new FalconCMD());
//        getCommand("falcon").setTabCompleter(new TabComplete());
        FalconCommand falconCommand = new FalconCommand(
                new StatusCommand(),
                new RemoteCommand(),
