...
public class SQLite implements IDatabase {
    ...
    public boolean connect() {
        ...
        if (!folder.exists()) {
            if (!folder.mkdir()) {
                Main.log("Could not create /Cache folder!", true);
            }
        }
        ...
        if (!dataFolder.exists()) {
            try {
                if (!dataFolder.createNewFile()) {
                    Main.log("Could not create /Cache/cache.db file!", true);
                }
            } catch (IOException e) {
                e.printStackTrace();
                return false;
        ...
        try {
            ...
            if (e instanceof ClassNotFoundException) {
                Main.log("Could Not Found SQLite Driver on your system!", true);
            }
            e.printStackTrace();
            return false;
        }
