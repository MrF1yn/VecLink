...
public class MySQL implements IDatabase {
     ...
     */
    public MySQL() {
        this.host = Main.config.getDbConfig().getString("storage.mysql.host");
        this.database = Main.config.getDbConfig().getString("storage.mysql.database");
        this.user = Main.config.getDbConfig().getString("storage.mysql.username");
        this.pass = Main.config.getDbConfig().getString("storage.mysql.password");
        this.port = Main.config.getDbConfig().getInt("storage.mysql.port");
        this.ssl = Main.config.getDbConfig().getBoolean("storage.mysql.ssl");
        this.certificateVerification = Main.config.getDbConfig().getBoolean("storage.mysql.verify-certificate", true);
        this.poolSize = Main.config.getDbConfig().getInt("storage.mysql.pool-size", 10);
    ...
    public boolean connect() {
        ...
        hikariConfig.setPoolName("VecLinkServerMySQLPool");
