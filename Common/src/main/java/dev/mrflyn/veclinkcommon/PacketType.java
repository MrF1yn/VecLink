...
//PC2S means the packet is only sent from a proxyVecLinkClient like Velocity or Bungee.
    ...
    C2S_DC_CHAT_MONITOR_INIT(new PacketFormat(Integer.class, String.class),
            "This packet is sent from veclink srv and contains the incoming chatmonitoring format."),
    C2S_DC_CHAT_MONITOR(new PacketFormat(Integer.class, String.class),
            "This packet is sent from veclink client and contains the formatted chat message."),
    C2S_CHAT_BROADCAST(new PacketFormat(Integer.class, String.class, String.class),
            "This packet is sent from client and contains the target server and the message."),
    ...
    S2C_DC_CHAT_MONITOR_INIT(new PacketFormat(Integer.class, String.class),
            "This packet is sent from veclink server and contains the incoming chatmonitoring format."),
    S2C_CHAT_BROADCAST(new PacketFormat(Integer.class, String.class, String.class),
            "This packet is sent from client and contains the target server and the message."),
    S2C_DC_CHAT_MONITOR(new PacketFormat(Integer.class, String.class, String.class),
            "This packet is sent from veclink server to veclink srv and contains the formatted chat message and clientName."),
