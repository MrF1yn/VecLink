...
public class PostgreSQL implements IDatabase {
    ...
    public PostgreSQL(String host, String database, String user, String pass, int port, boolean ssl, boolean certificateVerification, int poolSize, int maxLifetime) {
        this.host = host;
    ...
    public boolean connect() {
        ...
        hikariConfig.setPoolName("VecLinkClientPostgreSQLPool");
