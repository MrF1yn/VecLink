package FalconClientVelocity.commands.handler;
...
public class FalconCommand implements SimpleCommand {
    private HashMap<String, SubCommand> registeredSubCommands = new HashMap<>();
    private List <String> results = new ArrayList<>();

    public FalconCommand(SubCommand... subCommands){
    ...
    public void execute(Invocation invocation) {
        ...
        if(subCommand.isProtected()&&!(sender.hasPermission(subCommand.getPermission())||sender.hasPermission("falcon.admin"))) {
            //NO permission
